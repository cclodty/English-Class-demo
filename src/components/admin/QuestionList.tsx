      ...
      {questions.map((q) => {
        ...
        return (
          <div key={q.id} className="flex items-start gap-3 py-3 px-1 hover:bg-gray-50 rounded-lg group">
            <span className="text-xs font-mono text-gray-400 mt-0.5 w-20 flex-shrink-0 truncate">{q.id}</span>
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-700 line-clamp-2 leading-snug">{q.text}</p>
            </div>
